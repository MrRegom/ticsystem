...
class UsuarioService:
    ...
    def crear_usuario(cls, rut: str, nombres: str, apellidos: str, correo: str,
                      unidad: str, cargo: str, grado: str, contrasena: str) -> User:
        """
    ...
    def actualizar_usuario(cls, user_id: int, nombres: str, apellidos: str, correo: str,
                           unidad: str, cargo: str, grado: str, rut: str = None, contrasena: str = None) -> User:
        """
        ...
        perfil.unidad = unidad.strip()
        perfil.cargo = cargo.strip()
        perfil.grado = grado.strip()
