    ...
    const tablaHistorial = $('#tabla-historial-actas').DataTable({
        ...
        columns: [
            ...
            { data: null, orderable: false, render: function(data, type, row) {
                let html = '<div class="ms-row-actions" style="position:static; opacity:1; background:transparent; padding:0; display:flex; gap:8px; justify-content:center; align-items:center; width:100%; transform:none !important; margin-top:0;">';
                if (row.pdf_url) {
